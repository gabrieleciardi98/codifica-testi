...
<!-- informazioni aggiuntive-->
  ...
  <div hidden="hidden" class="blocco2">
    ...
    <p><xsl:value-of select="//tei:correspAction"/></p>
    <p><xsl:value-of select="//tei:correspContext"/></p>
    <p><xsl:value-of select="//tei:textClass"/><xsl:value-of select="//tei:langUsage"/></p>
  </div>
